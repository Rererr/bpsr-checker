...
const IMAGINE_DEBUFFS: &[(i64, i32, i64)] = &[
    ...
    (90005, 2110056, 80_000),    // ミレイユ: ティナ
    (90005, 2110057, 65_000),    // ミレイユ: アルーナ
    (90006, 2110055, 50_000),    // リコリス: タータ
    (90006, 2110050, 45_000),    // リコリス: バジリスク
    (90006, 2110056, 70_000),    // リコリス: ティナ
    (90007, 2110050, 55_000),    // ティオ: バジリスク
    (90007, 2110055, 60_000),    // ティオ: タータ
    (90008, 2110057, 85_000),    // ユズリハ: アルーナ
    (90008, 2110056, 75_000),    // ユズリハ: ティナ
    (90008, 2110050, 48_000),    // ユズリハ: バジリスク
    (SELF_UID, 2110049, 60_000), // ソラ: ガトグリフ
    (90003, 2110049, 42_000),    // ハヤテ: ガトグリフ
    (90005, 2110049, 58_000),    // ミレイユ: ガトグリフ
    (90007, 2110049, 35_000),    // ティオ: ガトグリフ
];
