...
SPECIAL = {
    ...
    2010066: "沈夢耐性3",
    3001161: "虚蝕の力",
    # S3 イベント食事「美食の加護」(NameDesign=美食的加护・非構造化)。効果は Desc(英)由来。
    2010071: "美食の加護(幸運+2%)",
    2010072: "美食の加護(会心+2%)",
    2010073: "美食の加護(ファスト+2%)",
    2010074: "美食の加護(器用+2%)",
    2010075: "美食の加護(万能+2%)",
    2010076: "美食の加護(防御+HP回復)",
    2010077: "美食の加護(筋力+5%)",
    2010078: "美食の加護(知力+5%)",
    2010079: "美食の加護(敏捷+5%)",
    2010081: "美食の加護(防御+HP回復)",
    2010082: "美食の加護(力知敏+会心)",
    2010083: "美食の加護(力知敏+幸運)",
    2010084: "美食の加護(力知敏+ファスト)",
    2010085: "美食の加護(力知敏+器用)",
    2010086: "美食の加護(力知敏+万能)",
    # S3 ブースト系シロップ(NameDesign 空・Desc のみ)。
    2033171: "物理増幅 +360",
    2033172: "物理増幅 +360",
    2033173: "物理増幅 +360",
    2033181: "魔法増幅 +360",
