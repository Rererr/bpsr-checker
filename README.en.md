...
- **Equipped Battle Imagine name** — Shows each player's equipped Battle Imagine (Tina / Airona / Tatta / Basilisk, etc.) appended to the name column of the DPS list (e.g. `Sora-Tina/Airona`). The `{imagine}` token in the name-column template lets you reposition it, or remove it to hide. It is always shown in the header of the per-skill breakdown you open by clicking a player.
...
- Every release is scanned on VirusTotal: [installer](https://www.virustotal.com/gui/file/903c7b4afbec1128de371758e941024c6b7cfc6a9905a59ad52323f87814e6c9/detection) · [portable](https://www.virustotal.com/gui/file/d764790e344458d95e0ca39e77f7af963ecd0ece924917bad120024bdcbe90c0/detection).
