...
- **Class icon display** — Shows the class icon, tinted by role color (attacker / tank / healer), before each name in the DPS list (on by default). Remove the `{classIcon}` token from the name-column template to hide it.
...
- **Global shortcut keys** — Assign global shortcut keys (they work even while the game window has focus) to reset, pause/resume, start/cancel the 3-minute measurement, copy the list, and toggle always-on-top. Configured from the settings panel; nothing is assigned by default.
...
- Every release is scanned on VirusTotal: [installer](https://www.virustotal.com/gui/file/5d9aaaf8a788f1152dd9a2342b685623590a1d5ab8003807746bb1532180ae36/detection) · [portable](https://www.virustotal.com/gui/file/608a23dea18b18dd1b7c1bf76321ac9ef78685b24a06a0381c57552a76fe9980/detection).
